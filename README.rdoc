...
RuleSet uses [array_logic][1] to manage the logic used to compare each rule
set with the array of answers.
...
[1]: https://github.com/reggieb/array_logic "array_logic on github"